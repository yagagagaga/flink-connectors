...
public class HBase2DynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
	...
	public DynamicTableSource createDynamicTableSource(Context context) {
		...
		HBaseLookupOptions.Builder lookupOptionsBuilder = HBaseLookupOptions.builder()
				.setCacheMaxSize(helper.getOptions().get(LOOKUP_CACHE_MAX_ROWS))
				.setCacheExpireMs(helper.getOptions().get(LOOKUP_CACHE_TTL).toMillis());
