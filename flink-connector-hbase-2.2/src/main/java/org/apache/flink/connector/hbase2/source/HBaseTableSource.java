...
public class HBaseTableSource extends AbstractHBaseTableSource {
	...
	public HBaseTableSource(Configuration conf, String tableName, HBaseTableSchema hbaseSchema, int[] projectFields) {
		this(conf, tableName, hbaseSchema, projectFields, HBaseLookupOptions.builder().build());
	}

	public HBaseTableSource(Configuration hbaseClientConf, String hTableName, HBaseTableSchema hbaseSchema, int[] projectFields, HBaseLookupOptions hbaseLookupOptions) {
		super(hbaseClientConf, hTableName, hbaseSchema, projectFields, hbaseLookupOptions);
	}
