...
public class HBaseDynamicTableSource extends AbstractHBaseDynamicTableSource {
	...
	public HBaseDynamicTableSource(Configuration conf, String tableName, HBaseTableSchema hbaseSchema,
			HBaseLookupOptions lookupOptions, String nullStringLiteral) {
		super(conf, tableName, hbaseSchema, lookupOptions, nullStringLiteral);
	}

	@Override
	public DynamicTableSource copy() {
		return new HBaseDynamicTableSource(conf, tableName, hbaseSchema, lookupOptions, nullStringLiteral);
	}
