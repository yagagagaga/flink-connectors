...
import static org.apache.flink.table.descriptors.AbstractHBaseValidator.CONNECTOR_LOOKUP_CACHE_MAX_ROWS;
import static org.apache.flink.table.descriptors.AbstractHBaseValidator.CONNECTOR_LOOKUP_CACHE_TTL;
...
public class HBase1TableFactory implements StreamTableSourceFactory<Row>, StreamTableSinkFactory<Tuple2<Boolean, Row>> {
	...
	public StreamTableSource<Row> createStreamTableSource(Map<String, String> properties) {
		...
		HBaseLookupOptions hbaseLookupOptions = getHBaseLookupOptions(descriptorProperties);
		return new HBaseTableSource(hbaseClientConf, hTableName, hbaseSchema, null, hbaseLookupOptions);
	}
	...
	private HBaseLookupOptions getHBaseLookupOptions(DescriptorProperties descriptorProperties) {
		final HBaseLookupOptions.Builder builder = HBaseLookupOptions.builder();
